...
namespace Vital::Sandbox::API {
    struct SSR : vm_module {
        static void bind(Machine* vm) {
            ...
            API::bind(vm, {"engine", "ssr"}, "set_enabled", [](auto vm) -> int {
            ...
            API::bind(vm, {"engine", "ssr"}, "is_enabled", [](auto vm) -> int {
                vm -> push_bool(Vital::Godot::Core::get_environment() -> is_ssr_enabled());
                return 1;
            });
        
            API::bind(vm, {"engine", "ssr"}, "set_max_steps", [](auto vm) -> int {
            ...
            API::bind(vm, {"engine", "ssr"}, "get_max_steps", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_ssr_max_steps());
                return 1;
            });
        
            API::bind(vm, {"engine", "ssr"}, "set_fade_in", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
            ...
            API::bind(vm, {"engine", "ssr"}, "get_fade_in", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_ssr_fade_in());
                return 1;
            });
        
            API::bind(vm, {"engine", "ssr"}, "set_fade_out", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"engine", "ssr"}, "get_fade_out", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_ssr_fade_out());
                return 1;
            });
        
            API::bind(vm, {"engine", "ssr"}, "set_depth_tolerance", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"engine", "ssr"}, "get_depth_tolerance", [](auto vm) -> int {
