...
namespace Vital::Sandbox::API {
    struct SDFGI : vm_module {
        static void bind(Machine* vm) {
            ...
            API::bind(vm, {"engine", "sdfgi"}, "is_enabled", [](auto vm) -> int {
                vm -> push_bool(Vital::Godot::Core::get_environment() -> is_sdfgi_enabled());
                return 1;
            });

            API::bind(vm, {"engine", "sdfgi"}, "set_enabled", [](auto vm) -> int {
            ...
            API::bind(vm, {"engine", "sdfgi"}, "set_cascades", [](auto vm) -> int {
            ...
            API::bind(vm, {"engine", "sdfgi"}, "get_cascades", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_sdfgi_cascades());
                return 1;
            });
        
            API::bind(vm, {"engine", "sdfgi"}, "set_min_cell_size", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
            ...
            API::bind(vm, {"engine", "sdfgi"}, "get_min_cell_size", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_sdfgi_min_cell_size());
                return 1;
            });
        
            API::bind(vm, {"engine", "sdfgi"}, "set_max_distance", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"engine", "sdfgi"}, "get_max_distance", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_sdfgi_max_distance());
                return 1;
            });
        
            API::bind(vm, {"engine", "sdfgi"}, "set_y_scale", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_int(1);
            ...
            API::bind(vm, {"engine", "sdfgi"}, "get_y_scale", [](auto vm) -> int {
            ...
            API::bind(vm, {"engine", "sdfgi"}, "set_bounce_feedback", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"engine", "sdfgi"}, "get_bounce_feedback", [](auto vm) -> int {
            ...
            API::bind(vm, {"engine", "sdfgi"}, "set_energy", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"engine", "sdfgi"}, "get_energy", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_sdfgi_energy());
                return 1;
            });
        
            API::bind(vm, {"engine", "sdfgi"}, "set_normal_bias", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"engine", "sdfgi"}, "get_normal_bias", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_sdfgi_normal_bias());
                return 1;
            });
        
            API::bind(vm, {"engine", "sdfgi"}, "set_probe_bias", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"engine", "sdfgi"}, "get_probe_bias", [](auto vm) -> int {
