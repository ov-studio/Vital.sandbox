...
namespace Vital::Sandbox::API {
    struct Adjustment : vm_module {
        static void bind(Machine* vm) {            
            ...
            API::bind(vm, {"gfx", "adjustment"}, "is_enabled", [](auto vm) -> int {
                vm -> push_bool(Vital::Godot::Core::get_environment() -> is_adjustment_enabled());
                return 1;
            });
    
            API::bind(vm, {"gfx", "adjustment"}, "set_enabled", [](auto vm) -> int {
            ...
            API::bind(vm, {"gfx", "adjustment"}, "set_brightness", [](auto vm) -> int {
            ...
            API::bind(vm, {"gfx", "adjustment"}, "get_brightness", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_adjustment_brightness());
                return 1;
            });
        
            API::bind(vm, {"gfx", "adjustment"}, "set_contrast", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"gfx", "adjustment"}, "get_contrast", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_adjustment_contrast());
                return 1;
            });
        
            API::bind(vm, {"gfx", "adjustment"}, "set_saturation", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_number(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto value = vm -> get_float(1);
            ...
            API::bind(vm, {"gfx", "adjustment"}, "get_saturation", [](auto vm) -> int {
                vm -> push_number(Vital::Godot::Core::get_environment() -> get_adjustment_saturation());
                return 1;
            });

            API::bind(vm, {"gfx", "adjustment"}, "set_lut", [](auto vm) -> int {
            ...
            API::bind(vm, {"gfx", "adjustment"}, "get_lut", [](auto vm) -> int {
                if (vm -> is_reference("lut_path")) vm -> get_reference("lut_path", true);
                else vm -> push_bool(false);
                return 1;
            });

            API::bind(vm, {"gfx", "adjustment"}, "reset_lut", [](auto vm) -> int {
