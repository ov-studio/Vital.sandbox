...
namespace Vital::Sandbox::API {
    struct Model : vm_module {
        inline static const std::string class_name = "Model";
        using class_self = Vital::Godot::Model;

        static void bind(Machine* vm) {
            vm_module::register_type<Model>(vm, class_name);

            API::bind(vm, {class_name}, "is_loaded", [](auto vm) -> int {
            ...
            API::bind(vm, {class_name}, "load", [](auto vm) -> int {
            ...
            API::bind(vm, {class_name}, "unload", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_string(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                vm -> push_bool(Vital::Godot::Model::unload_model(vm -> get_string(1)));
                return 1;
            });

            API::bind(vm, {class_name}, "create", [](auto vm) -> int {
                if ((vm -> get_arg_count() < 1) || (!vm -> is_string(1))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
                auto* object = Vital::Godot::Model::create_object(vm -> get_string(1));
                vm -> create_object(class_name, object);
                return 1;
            });
        }

        static void methods(Machine* vm) {
            vm_module::bind_method<class_self>(vm, class_name, "is_component_visible", [](auto vm, auto self) -> int {
            ...
            vm_module::bind_method<class_self>(vm, class_name, "is_animation_playing", [](auto vm, auto self) -> int {
                vm -> push_bool(self -> is_animation_playing());
                return 1;
            });

            vm_module::bind_method<class_self>(vm, class_name, "set_position", [](auto vm, auto self) -> int {
            ...
            vm_module::bind_method<class_self>(vm, class_name, "set_rotation", [](auto vm, auto self) -> int {
                if ((vm -> get_arg_count() < 4) || (!vm -> is_number(2)) || (!vm -> is_number(3)) || (!vm -> is_number(4))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
            ...
            vm_module::bind_method<class_self>(vm, class_name, "set_component_visible", [](auto vm, auto self) -> int {
            ...
            vm_module::bind_method<class_self>(vm, class_name, "set_animation_speed", [](auto vm, auto self) -> int {
            ...
            vm_module::bind_method<class_self>(vm, class_name, "set_blend_shape_value", [](auto vm, auto self) -> int {
            ...
            vm_module::bind_method<class_self>(vm, class_name, "get_model_name", [](auto vm, auto self) -> int {
                vm -> push_string(self -> get_model_name());
                return 1;
            });

            vm_module::bind_method<class_self>(vm, class_name, "get_position", [](auto vm, auto self) -> int {
                auto p = self -> get_position();
                vm -> push_number(p.x); vm -> push_number(p.y); vm -> push_number(p.z);
                return 3;
            });

            vm_module::bind_method<class_self>(vm, class_name, "get_rotation", [](auto vm, auto self) -> int {
                auto r = self -> get_rotation();
                vm -> push_number(r.x); vm -> push_number(r.y); vm -> push_number(r.z);
                return 3;
            });

            vm_module::bind_method<class_self>(vm, class_name, "get_components", [](auto vm, auto self) -> int {
            ...
            vm_module::bind_method<class_self>(vm, class_name, "get_animations", [](auto vm, auto self) -> int {
            ...
            vm_module::bind_method<class_self>(vm, class_name, "get_blend_shapes", [](auto vm, auto self) -> int {
                if ((vm -> get_arg_count() < 2) || (!vm -> is_string(2))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
            ...
            vm_module::bind_method<class_self>(vm, class_name, "get_current_animation", [](auto vm, auto self) -> int {
                vm -> push_string(self -> get_current_animation());
                return 1;
            });

            vm_module::bind_method<class_self>(vm, class_name, "get_animation_speed", [](auto vm, auto self) -> int {
                vm -> push_number(self -> get_animation_speed());
                return 1;
            });

            vm_module::bind_method<class_self>(vm, class_name, "get_blend_shape_value", [](auto vm, auto self) -> int {
            ...
            vm_module::bind_method<class_self>(vm, class_name, "play_animation", [](auto vm, auto self) -> int {
                if ((vm -> get_arg_count() < 2) || (!vm -> is_string(2))) throw Vital::Log::fetch("invalid-arguments", Vital::Log::Type::Error);
            ...
            vm_module::bind_method<class_self>(vm, class_name, "stop_animation", [](auto vm, auto self) -> int {
                self -> stop_animation();
                vm -> push_bool(true);
                return 1;
            });

            vm_module::bind_method<class_self>(vm, class_name, "pause_animation", [](auto vm, auto self) -> int {
                self -> pause_animation();
                vm -> push_bool(true);
                return 1;
            });

            vm_module::bind_method<class_self>(vm, class_name, "resume_animation", [](auto vm, auto self) -> int {
                self -> resume_animation();
                vm -> push_bool(true);
                return 1;
            });

            vm_module::bind_method<class_self>(vm, class_name, "destroy", [](auto vm, auto self) -> int {
                self -> queue_free();
                vm -> push_bool(true);
                return 1;
            });
