...
void Vital::Godot::Sandbox::Lua::API::SSR::bind(void* instance) {
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "is_enabled", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::create::fetch_vm(ref);
        return vm -> execute([&]() -> int {
            vm -> set_bool(Vital::Godot::Core::get_environment() -> is_ssr_enabled());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "get_max_steps", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::create::fetch_vm(ref);
        return vm -> execute([&]() -> int {
            vm -> set_number(Vital::Godot::Core::get_environment() -> get_ssr_max_steps());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "get_fade_in", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::create::fetch_vm(ref);
        return vm -> execute([&]() -> int {
            vm -> set_number(Vital::Godot::Core::get_environment() -> get_ssr_fade_in());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "get_fade_out", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::create::fetch_vm(ref);
        return vm -> execute([&]() -> int {
            vm -> set_number(Vital::Godot::Core::get_environment() -> get_ssr_fade_out());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "get_depth_tolerance", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::create::fetch_vm(ref);
        return vm -> execute([&]() -> int {
            vm -> set_number(Vital::Godot::Core::get_environment() -> get_ssr_depth_tolerance());
            return 1;
        });
    });
    #endif
