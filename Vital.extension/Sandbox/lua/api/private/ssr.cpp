...
void Vital::Godot::Sandbox::Lua::API::SSR::bind(void* instance) {
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "setEnabled", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            ...
            Vital::Godot::Engine::get_environment() -> set_ssr_enabled(state);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "isEnabled", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setBool(Vital::Godot::Engine::get_environment() -> is_ssr_enabled());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "setMaxSteps", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            ...
            Vital::Godot::Engine::get_environment() -> set_ssr_max_steps(value);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "getMaxSteps", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setNumber(Vital::Godot::Engine::get_environment() -> get_ssr_max_steps());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "setFadeIn", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            ...
            Vital::Godot::Engine::get_environment() -> set_ssr_fade_in(value);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "getFadeIn", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setNumber(Vital::Godot::Engine::get_environment() -> get_ssr_fade_in());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "setFadeOut", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            if ((vm -> getArgCount() < 1) || (!vm -> isNumber(1))) throw std::runtime_error(ErrorCode["invalid-arguments"]);
            auto value = vm -> getFloat(1);
            Vital::Godot::Engine::get_environment() -> set_ssr_fade_out(value);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "getFadeOut", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setNumber(Vital::Godot::Engine::get_environment() -> get_ssr_fade_out());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "setDepthTolerance", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            if ((vm -> getArgCount() < 1) || (!vm -> isNumber(1))) throw std::runtime_error(ErrorCode["invalid-arguments"]);
            auto value = vm -> getFloat(1);
            Vital::Godot::Engine::get_environment() -> set_ssr_depth_tolerance(value);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "ssr", "getDepthTolerance", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setNumber(Vital::Godot::Engine::get_environment() -> get_ssr_depth_tolerance());
            return 1;
        });
    });
    #endif
