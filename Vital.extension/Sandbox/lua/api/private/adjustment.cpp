...
void Vital::Godot::Sandbox::Lua::API::Adjustment::bind(void* instance) {
    ...
    Vital::Sandbox::Lua::API::bind(vm, "adjustment", "setEnabled", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            ...
            Vital::Godot::Engine2::get_environment() -> set_adjustment_enabled(state);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "adjustment", "isEnabled", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setBool(Vital::Godot::Engine2::get_environment() -> is_adjustment_enabled());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "adjustment", "setBrightness", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            ...
            Vital::Godot::Engine2::get_environment() -> set_adjustment_brightness(value);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "adjustment", "getBrightness", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setNumber(Vital::Godot::Engine2::get_environment() -> get_adjustment_brightness());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "adjustment", "setContrast", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            if ((vm -> getArgCount() < 1) || (!vm -> isNumber(1))) throw std::runtime_error(ErrorCode["invalid-arguments"]);
            auto value = vm -> getFloat(1);
            Vital::Godot::Engine2::get_environment() -> set_adjustment_contrast(value);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "adjustment", "getContrast", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setNumber(Vital::Godot::Engine2::get_environment() -> get_adjustment_contrast());
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "adjustment", "setSaturation", [](auto* ref) -> int {
        ...
        return vm -> execute([&]() -> int {
            if ((vm -> getArgCount() < 1) || (!vm -> isNumber(1))) throw std::runtime_error(ErrorCode["invalid-arguments"]);
            auto value = vm -> getFloat(1);
            Vital::Godot::Engine2::get_environment() -> set_adjustment_saturation(value);
            vm -> setBool(true);
            return 1;
        });
    });
    ...
    Vital::Sandbox::Lua::API::bind(vm, "adjustment", "getSaturation", [](auto* ref) -> int {
        auto vm = Vital::Sandbox::Lua::fetchVM(ref);
        return vm -> execute([&]() -> int {
            vm -> setNumber(Vital::Godot::Engine2::get_environment() -> get_adjustment_saturation());
            return 1;
        });
    });
    #endif
