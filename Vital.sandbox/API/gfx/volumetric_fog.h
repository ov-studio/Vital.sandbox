...
namespace Vital::Sandbox::API {
    struct Volumetric_Fog : vm_module {
        ...
        static void bind(Machine* vm) {
            API::bind(vm, {base_name, "volumetric_fog"}, "is_enabled", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> is_volumetric_fog_enabled());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_enabled", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(state)")
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "set_emission", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(color)")
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_emission", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_emission());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_albedo", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(color)")
                    .require(1, &Machine::is_color);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_albedo", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_albedo());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_density", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_density", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_density());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_emission_energy", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
                    .require(1, &Machine::is_number);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_emission_energy", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_emission_energy());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_anisotropy", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
                    .require(1, &Machine::is_number);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_anisotropy", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_anisotropy());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_length", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
                    .require(1, &Machine::is_number);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_length", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_length());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_detail_spread", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
                    .require(1, &Machine::is_number);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_detail_spread", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_detail_spread());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_gi_inject", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
                    .require(1, &Machine::is_number);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_gi_inject", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_gi_inject());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_ambient_inject", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
                    .require(1, &Machine::is_number);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_ambient_inject", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_ambient_inject());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_sky_affect", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
                    .require(1, &Machine::is_number);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_sky_affect", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> get_volumetric_fog_sky_affect());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "is_temporal_reprojection_enabled", [](auto vm, auto& id) -> int {
                vm -> push_value(base_class::get_environment() -> is_volumetric_fog_temporal_reprojection_enabled());
                return 1;
            });

            API::bind(vm, {base_name, "volumetric_fog"}, "set_temporal_reprojection_enabled", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(state)")
                    .require(1, &Machine::is_bool);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "set_temporal_reprojection_amount", [](auto vm, auto& id) -> int {
                vm_args(vm, id, "(value)")
                    .require(1, &Machine::is_number);
            ...
            API::bind(vm, {base_name, "volumetric_fog"}, "get_temporal_reprojection_amount", [](auto vm, auto& id) -> int {
