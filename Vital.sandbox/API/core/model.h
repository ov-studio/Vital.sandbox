    ...
    struct Model : vm_module {
        ...
        static void on_model_node_destroyed(base_class* dying) {
            ...
            for (auto it = registry.buffer.begin(); it != registry.buffer.end();) {
                ...
                ++it;
                Manager::Sandbox::get_singleton() -> signal("entity:on_destroyed", Tool::StackValue(instance));
        ...
        static void bind(Machine* vm) {
            ...
            base_class::on_spawned_callback = [vm](base_class* spawned, bool remote) {
                ...
                Manager::Sandbox::get_singleton() -> signal("entity:on_created", Tool::StackValue(instance));
            };
