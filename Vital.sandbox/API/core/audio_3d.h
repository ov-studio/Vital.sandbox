    ...
    struct Audio_3D : vm_module {
        ...
        static void methods(Machine* vm) {
            ...
            vm_module::bind_method<Instance>(vm, "get_max_volume", [](auto vm, auto self, auto& id) -> int {
                vm -> push_value(godot::Math::db2linear(self -> audio -> get_player() -> get_max_db()));
                return 1;
            });
            ...
            vm_module::bind_method<Instance>(vm, "set_max_volume", [](auto vm, auto self, auto& id) -> int {
                ...
                auto value = vm -> get_float(2);
                self -> audio -> get_player() -> set_max_db(godot::Math::linear2db(value));
                vm -> push_value(true);
                return 1;
            });
            ...
            vm_module::bind_method<Instance>(vm, "set_unit_size", [](auto vm, auto self, auto& id) -> int {
                ...
                auto value = vm -> get_float(2);
                self -> audio -> get_player() -> set_unit_size(value);
                vm -> push_value(true);
                return 1;
            });
            ...
            vm_module::bind_method<Instance>(vm, "set_emission_angle_enabled", [](auto vm, auto self, auto& id) -> int {
                ...
                auto state = vm -> get_bool(2);
                self -> audio -> get_player() -> set_emission_angle_enabled(state);
                vm -> push_value(true);
                return 1;
            });
            ...
            vm_module::bind_method<Instance>(vm, "set_emission_angle", [](auto vm, auto self, auto& id) -> int {
                ...
                auto value = vm -> get_float(2);
                self -> audio -> get_player() -> set_emission_angle(value);
                vm -> push_value(true);
                return 1;
            });
            ...
            vm_module::bind_method<Instance>(vm, "set_emission_angle_filter_attenuation_db", [](auto vm, auto self, auto& id) -> int {
                ...
                auto value = vm -> get_float(2);
                self -> audio -> get_player() -> set_emission_angle_filter_attenuation_db(value);
                vm -> push_value(true);
                return 1;
            });
            ...
            vm_module::bind_method<Instance>(vm, "set_attenuation_filter_cutoff_hz", [](auto vm, auto self, auto& id) -> int {
                ...
                auto value = vm -> get_float(2);
                self -> audio -> get_player() -> set_attenuation_filter_cutoff_hz(value);
                vm -> push_value(true);
                return 1;
            });
            ...
            vm_module::bind_method<Instance>(vm, "set_attenuation_filter_db", [](auto vm, auto self, auto& id) -> int {
                ...
                auto value = vm -> get_float(2);
                self -> audio -> get_player() -> set_attenuation_filter_db(value);
                vm -> push_value(true);
                return 1;
            });
