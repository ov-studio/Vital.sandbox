    ...
    class Network : public godot::Node {
        ...
        private:
            static void _bind_methods() {
                ...
                godot::ClassDB::bind_method(godot::D_METHOD("_force_transform", "net_id", "pos", "rot"), &Network::_force_transform);
                godot::ClassDB::bind_method(godot::D_METHOD("_sync_scale", "net_id", "scale"), &Network::_sync_scale);
        ...
        public:
            ...
            void _force_transform(int net_id, godot::Vector3 pos, godot::Vector3 rot);
            void _sync_scale(int net_id, godot::Vector3 scale);
            #if defined(VSDK_Client)
