project "Vital.sandbox"
    ...
    filter "configurations:Debug"
        links { "Vendor/openssl/lib/%{cfg.platform}/Debug/libcrypto.lib", "Vendor/openssl/lib/%{cfg.platform}/Debug/libssl.lib", "Vendor/fmod/lib/%{cfg.platform}/fmodL_vc.dll", "ws2_32", "crypt32" }
        postbuildcommands {
    ...
    filter "configurations:Release"
        links { "Vendor/openssl/lib/%{cfg.platform}/Release/libcrypto.lib", "Vendor/openssl/lib/%{cfg.platform}/Release/libssl.lib", "Vendor/fmod/lib/%{cfg.platform}/fmod_vc.dll", "ws2_32", "crypt32"  }
        postbuildcommands {
